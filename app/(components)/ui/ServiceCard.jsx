...
const ServiceCard = () => {
  return (
    <div className=' w-full md:w-[230px] flex flex-col items-start gap-y-4'>
 ...
 <h3 className='font-bold text-xl text-slate-950 underline'>Prevetive Care</h3>
 <p className='text-[#788082] '>Regular check-ups and fluoride treatments to prevent tooth decay and gum disease.</p>
    </div>
  )
}
